	...
	_goToLogout = () => {
		...
		.then((responseJson) => {
			...
			if(responseJson.status === 200) {
				...
				this.props.navigation.navigate('Login', {id: "Subscriber"});
					...
					<View style={ styles.input }>
						<TouchableHighlight style={{ borderRadius: 25 }} 
							...
							<View style={ this.state.pressStatusActiveBidPhotos ? styles.pressButton : styles.styleTouchable }>
								<Text style={ this.state.pressStatusActiveBidPhotos ? styles.pressText : styles.textInput }>Purchased Photos</Text>
