...
export default class UpgradePhoto extends Component {
		...
		return(
			<View style={styles.container}>
				...
				<View style={styles.container1}>
					...
					<View style={{}}>
							<Text style={{fontSize: 24, color: '#56c2b5', fontWeight: 'bold'}}>$111</Text>
							
							<Text style={{marginTop: 15, marginBottom: 25, fontSize: 10, color: '#8c8c8c'}}>
								John Carter John Carter John Carter John Carter John Carter 
								John Carter John Carter John Carter John Carter John Carter John Carter John Carter 
							</Text>
					</View>
					...
					<ImageBackground style={{marginTop: 15}} imageStyle={{ borderRadius: 5 }}
						...
						<TouchableOpacity style={styles.button} 
							...
							<Text style={styles.buttonText}>SUBSCRIBER NOW</Text>
						</TouchableOpacity>
					</ImageBackground>
				</View>
