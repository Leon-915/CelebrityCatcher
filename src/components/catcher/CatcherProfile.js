	...
	componentDidMount() {
		...
		.then((responseJson) => {
			...
			if(responseJson.status === 200) {
				...
				userInfo.userId    = responseJson.data.id;                        //updating value
	...
	_goToLogout = () => {
		...
		.then((responseJson) => {
			...
			if(responseJson.status === 200) {
				...
				this.props.navigation.navigate('Login', {id: "Catcher"});
		...
		return(
			<View style={styles.container}>
				...
				<View style={styles.container2}>
					...
					<View style={ styles.input }>
						<TouchableHighlight style={{ borderRadius: 25 }} 
							onPress={() => this.props.navigation.navigate('CelebrityFollowing')}
							...
							<View style={ this.state.pressStatusCelebrityFollowing ? styles.pressButton : styles.styleTouchable }>
								<Text style={ this.state.pressStatusCelebrityFollowing ? styles.pressText : styles.textInput }>Celebrity Following</Text>
					...
					<View style={ styles.input }>
						<TouchableHighlight style={{ borderRadius: 25 }} 
							...
							<View style={ this.state.pressStatusPhotos ? styles.pressButton : styles.styleTouchable }>
								<Text style={ this.state.pressStatusPhotos ? styles.pressText : styles.textInput }>Photos</Text>
					...
					<View style={ styles.input }>
						<TouchableHighlight style={{ borderRadius: 25 }} 
							...
							<View style={ this.state.pressStatusActiveBidPhotos ? styles.pressButton : styles.styleTouchable }>
								<Text style={ this.state.pressStatusActiveBidPhotos ? styles.pressText : styles.textInput }>Active Bid Photos</Text>
